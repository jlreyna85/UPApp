...
import React, { useEffect, useState, useCallback } from 'react';
import { View, Text, StyleSheet, FlatList, TextInput, Alert, Picker, Button, Dimensions } from 'react-native';
import { collection, getDocs, doc, setDoc, query, where } from 'firebase/firestore';
import { db } from '../firebaseconfig';
...
const styles = StyleSheet.create({
  ...
  cell: {
    ...
    textAlign: 'center',
    backgroundColor: '#fff',
    height: width * 0.12, // Ajusta la altura en función del ancho de la pantalla
  },
  picker: {
    height: 50,
    width: '100%',
